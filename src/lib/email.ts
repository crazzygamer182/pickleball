...
export const sendTestEmail = async (playerEmail: string, playerName: string) => {
  const emailData: EmailData = {
    to: playerEmail,
    from: 'Vancouver Tennis Clash <admin@vancouvertennisclash.com>',
    subject: 'Test Email from Vancouver Tennis Clash',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #2563eb;">🎾 Vancouver Tennis Clash</h2>
        <p>Hello ${playerName},</p>
        <p>This is a test email from the Vancouver Tennis Clash admin system.</p>
        ...
        <p>Thank you for being part of our tennis community!</p>
        <p>Best regards,<br>Vancouver Tennis Clash Admin Team</p>
      </div>
    `,
    text: `Hello ${playerName},\n\nThis is a test email from the Vancouver Tennis Clash admin system.\n\nIf you're receiving this email, it means our automated email system is working correctly!\n\nThank you for being part of our tennis community!\n\nBest regards,\nVancouver Tennis Clash Admin Team`
  }
...
export const sendMatchNotificationEmail = async (player1Email: string, player1Name: string, player1Phone: string | undefined, player2Email: string, player2Name: string, player2Phone: string | undefined, week: number) => {
  const dashboardUrl = 'https://vancouvertennisclash.com/dashboard';
  
  // Email for Player 1
  const emailData1: EmailData = {
    to: player1Email,
    from: 'Vancouver Tennis Clash <admin@vancouvertennisclash.com>',
    subject: `Match Scheduled - Week ${week} - Vancouver Tennis Clash`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #2563eb;">🎾 Vancouver Tennis Clash</h2>
...
export const sendMatchCancellationEmail = async (player1Email: string, player1Name: string, player2Email: string, player2Name: string, week: number) => {
  ...
  const emailData1: EmailData = {
    to: player1Email,
    from: 'Vancouver Tennis Clash <admin@vancouvertennisclash.com>',
    subject: `Match Cancelled - Week ${week} - Vancouver Tennis Clash`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #dc2626;">🎾 Vancouver Tennis Clash</h2>
        <p>Hello ${player1Name},</p>
  ...
  const emailData: EmailData = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>A new user has joined one of the tennis ladders!</p>
